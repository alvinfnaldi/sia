		...
		<div class="collapse navbar-collapse" id="sidenav-collapse-main">
			...
			<div class="btn-group">
				...
				<div class="dropdown-menu">
					<li class="dropdown-item" style="font-size: 12px">Alvin Faiz Rinaldi </li>
					<li class="dropdown-item" style="font-size: 12px">Clark Kent Laurens </li>
					<li class="dropdown-item" style="font-size: 12px">Fatah Rizky Alfajriansyah </li>
					<li class="dropdown-item" style="font-size: 12px">Ilham Safari </li>
					<li class="dropdown-item" style="font-size: 12px">Muhammad Taufiq Nur Rahman </li>
					<li class="dropdown-item" style="font-size: 12px">Narakresna Natanta </li>
					<li class="dropdown-item" style="font-size: 12px">Sinatrio Bimo Wahyudi </li>
				</div>
			</div>
		</div>
	</div>
